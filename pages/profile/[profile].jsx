...
const Edit_user = () => {
	...
	const handleUpdateProfile = async () => {
		const url = 'https://bpa3u2c42e.execute-api.ap-south-1.amazonaws.com/dev/users';
		const data = {
			name: username,
			bio: "Bio",
			email: 'test@getMaxListeners.com',
			links: 'https://bpa3u2c42e.execute-api.com',
			profile: 'https://bpa3u2c42e.execute-api.com',
			cover: 'https://bpa3u2c42e.execute-api.com',
		};
